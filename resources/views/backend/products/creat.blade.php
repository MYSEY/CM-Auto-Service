                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="slug" id="slug" placeholder="product-slug" value="{{ old('slug') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="status" id="status">
                                        <option value="0" {{ old('status') == '0' ? 'selected' : '' }}>មានស្តុក (In Stock)</option>
                                        <option value="1" {{ old('status') == '1' ? 'selected' : '' }}>អស់ស្តុក (Out of Stock)</option>
                                    </select>
                                </div>
                            </div>
                        </div>
