...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" media="screen, print" href="{{asset('backends/css/page-login.css')}}">
    </head>
    <body>
        ...
        <video poster="{{asset('backends/img/backgrounds/clouds.png')}}" id="bgvid" playsinline autoplay muted loop>
            <source src="{{asset('backends/media/video/cc.webm')}}" type="video/webm">
            <source src="{{asset('backends/media/video/cc.mp4')}}" type="video/mp4">
        </video>
        <!-- base vendor bundle:
