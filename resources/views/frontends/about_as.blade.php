...
@section('content')
    ...
    <div class="about_bg_area">
       <div class="container">
                    ...
                    <div class="col-12">
                       <figure>
                            <div class="about_thumb">
                                <img src="{{asset('frontends/assets/img/about/about1.jpg')}}" alt="">
                            </div>
                            <figcaption class="about_content">
                                ...
                                <div class="about_signature">
                                    <img src="{{asset('frontends/assets/img/about/about-us-signature.png')}}" alt="">
                                </div>
                            </figcaption>
                        </figure>
                    </div>    
            ...
            <!--chose us area start-->
            <div class="choseus_area" data-bgimg="{{asset('frontends/assets/img/about/about-us-policy-bg.jpg')}}">
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <div class="single_chose">
                            <div class="chose_icone">
                                <img src="{{asset('frontends/assets/img/about/About_icon1.png')}}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="single_chose">
                            <div class="chose_icone">
                                <img src="{{asset('frontends/assets/img/about/About_icon2.png')}}" alt="">
                            </div>
                            <div class="chose_content">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="single_chose">
                            <div class="chose_icone">
                                <img src="{{asset('frontends/assets/img/about/About_icon3.png')}}" alt="">
                            </div>
                            <div class="chose_content">
                ...
                <div class="row">
                        ...
                        <article class="single_gallery_section">
                            <figure>
                                <div class="gallery_thumb">
                                    <img src="{{asset('frontends/assets/img/about/about2.jpg')}}" alt="">
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <article class="single_gallery_section">
                            <figure>
                                <div class="gallery_thumb">
                                    <img src="{{asset('frontends/assets/img/about/about3.jpg')}}" alt="">
                                </div>
                                <figcaption class="about_gallery_content">
                                    <h3>Our Mission</h3>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto</p>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <article class="single_gallery_section">
                            <figure>
                                <div class="gallery_thumb">
                                    <img src="{{asset('frontends/assets/img/about/about4.jpg')}}" alt="">
                                </div>
                                <figcaption class="about_gallery_content">
                                    <h3>History Of Us</h3>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto</p>
                        ...
                        <div class="testimonials-area">
                            ...
                            <div class="testimonial-two owl-carousel">
                                <div class="testimonial-wrap-two text-center">
                                    <div class="quote-container">
                                        <div class="quote-image">
                                            <img src="{{asset('frontends/assets/img/about/testimonial1.jpg')}}" alt="">
                                        </div>
                                ...
                                <div class="testimonial-wrap-two text-center">
                                    <div class="quote-container">
                                        <div class="quote-image">
                                            <img src="{{asset('frontends/assets/img/about/testimonial2.jpg')}}" alt="">
                                        </div>
                                        <div class="testimonials-text">
                                            <p>Support and response has been amazing, helping me with several issues I came across and got them solved almost the same day. A pleasure to work with them!</p>
                                        </div>
                                ...
                                <div class="testimonial-wrap-two text-center">
                                    <div class="quote-container">
                                        <div class="quote-image">
                                            <img src="{{asset('frontends/assets/img/about/testimonial3.jpg')}}" alt="">
                                        </div>
                                        <div class="testimonials-text">
                                            <p>Support and response has been amazing, helping me with several issues I came across and got them solved almost the same day. A pleasure to work with them!</p>
                                        </div>
