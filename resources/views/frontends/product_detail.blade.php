                    ...
                    <div class="col-lg-5 col-md-6">
                        <div class="product-details-tab">
                            <div id="img-1" class="zoomWrapper single-zoom">
                                <a href="#">
                                    <img id="zoom1" src="{{ asset('images/products/' . $product->product_photo) }}" data-zoom-image="{{ asset('images/products/' . $product->product_photo) }}" alt="big-1">
                                </a>
                            </div>
                        ...
                        <div class="product_d_right">
                            <form>
                                ...
                                <div class="price_box">
                                    ...
                                    <span class="current_price">${{ number_format($product->price - $product->discount_price,2) }}</span>
                                </div>
