...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('frontends/assets/img/favicon.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('frontends/assets/img/favicon.png') }}">
